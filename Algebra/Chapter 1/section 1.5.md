...
### 7. 分别求 $D_{2m-1}, D_{2m}$ 的中心，其中 $m \geq 2$。{#1.5.7}
$$
\begin{aligned}
...
### 20. 群 $G$ 的子群 $H$ 为正规子群当且仅当 $H$ 是 $G$ 的一些共轭类的并集。{#1.5.20}
